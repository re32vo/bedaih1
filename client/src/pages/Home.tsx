...
const testimonials = [
  ...
  },
  {
    ...
    role: "متبرعة",
    rating: 5,
    text: "تجربة التبرع عبر الموقع ممتازة وسريعة. اخترت المشروع المناسب وأتممت العملية خلال دقائق، ووصلني تأكيد واضح بالتفاصيل.",
  },
  {
    id: "t4",
    name: "خالد الزهراني",
    role: "متبرع",
    rating: 5,
    text: "أعجبتني الشفافية في عرض المشاريع والمبالغ المطلوبة. هذا شجعني أن أكرر التبرع أكثر من مرة وأنا مطمئن أن المبلغ يصل لمستحقيه.",
  },
  {
    id: "t5",
    name: "نورة السلمي",
  ...
  },
  {
    ...
    role: "متبرع",
    rating: 5,
    text: "جربت التبرع للجمعية في عدة حملات وكانت الخدمة ثابتة ومميزة. الدعم الفني سريع والتقارير واضحة، وهذا يعكس احترافية عالية.",
  },
];
