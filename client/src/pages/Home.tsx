        ...
        <section className="rounded-xl md:rounded-2xl border border-slate-200 bg-white p-3 sm:p-4 md:p-6 overflow-hidden">
          ...
          <div className="relative overflow-hidden">
            <div className="flex gap-5 animate-scroll-rtl" style={{ willChange: 'transform' }}>
              ...
              {partners.map((partner) => (
                <div key={`second-${partner.id}`} className="flex-shrink-0 w-[220px] h-28 flex items-center justify-center rounded-xl border border-slate-200 bg-slate-50 px-4 text-center text-base font-bold text-slate-600">
                  {partner.name}
                </div>
              ))}
