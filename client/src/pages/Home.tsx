...
export default function Home() {
    ...
    const fetchPublicStats = async () => {
      try {
        ...
        setPublicStats({
          ...
          beneficiariesCompletedCount: Number(data.beneficiariesCompletedCount) || 0,
  ...
  const stats: HomeStat[] = [
    ...
    { id: "s3", title: "مستفيد ومستفيدة", value: publicStats.beneficiariesCompletedCount, icon: Users },
    ...
    { id: "s6", title: "استشارات هاتفية", value: null, icon: TrendingUp },
              ...
              return (
                <div key={project.id} className="rounded-xl md:rounded-2xl border border-slate-200 bg-white shadow-sm">
                  <ResponsiveProjectImage
                    src={project.image}
                    alt={project.title}
                    wrapperClassName="rounded-t-xl md:rounded-t-2xl"
                  />
