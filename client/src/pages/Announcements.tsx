      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <Card className="mt-12">
          ...
          <CardContent>
            ...
            <button onClick={() => toast({ title: "تم التفعيل", description: "ستصلك آخر الإعلانات فور صدورها" })} className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-2 px-4 rounded-lg transition">
              فعّل التنبيهات
            </button>
          </CardContent>
        </Card>
