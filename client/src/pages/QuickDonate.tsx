          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
              {amounts.map((amount) => (
                <button
                  key={amount}
                  className="p-4 border-2 border-slate-300 hover:border-emerald-500 hover:bg-emerald-50 rounded-lg font-semibold text-slate-900 transition"
                >
                  {amount} ر.س
                </button>
              ))}
            ...
            <div className="mb-6">
              <label className="block text-sm font-semibold text-slate-900 mb-2">مبلغ مخصص</label>
              <div className="flex gap-2">
                <input type="number" placeholder="أدخل المبلغ" className="flex-1 px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500" />
